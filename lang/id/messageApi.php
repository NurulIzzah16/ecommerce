...
return [
    ...
    'OTP sent to your email' => 'OTP telah dikirim ke email Anda',
    ...
    'The provided data is invalid' => 'Data yang dimasukkan tidak valid',
    'An error occurred: ' => 'Terjadi kesalahan: ',
    'Product not found' => 'Produk tidak ditemukan',
    'Checkout completed successfully' => 'Checkout berhasil dilakukan',
    'Invalid notification' => 'Notifikasi tidak valid',
    'Payment not found' => 'Pembayaran tidak ditemukan',
    'Notification processed successfully' => 'Notifikasi diproses dengan sukses',
    'Product list successfully retrieved' => 'Daftar produk berhasil diambil',
    'Database errorr' => 'Kesalahan database',
    'Unexpected error' => 'Kesalahan tak terduga',
    'Account is not verified. An OTP has been sent to your email. Please verify to continue login' => 'Akun belum diverifikasi. OTP telah dikirimkan ke email Anda. Silakan verifikasi untuk melanjutkan login',
    'Token not found or has been deleted' => 'Token tidak ditemukan atau sudah dihapus',
